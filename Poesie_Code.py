...
def build_tables_for_pair(gr_tokens: list[str], de_tokens: list[str] = None, 
    ...
    for k in range(cols):
        ...
        # WICHTIG: Prüfe ob Tags TATSÄCHLICH im Token vorhanden sind!
        if gr_token:
