######## START: gr_build_poesie_adapter.py ########
...
def run_one(input_path: Path, language: str) -> None:
    ...
    # Pfad: /home/tobias/Desktop/Webseite_GODLIKE/texte/griechisch/poesie/Kategorie/Autor/Werk/datei.txt
    try:
        # Finde die Position von "texte/griechisch/poesie" im Pfad und extrahiere die Teile danach
...
def main():
    ...
    # Fester Pfad für griechische Poesie-Texte
    search_root = Path("/home/tobias/Desktop/Webseite_GODLIKE/texte/griechisch/poesie")
    if not search_root.is_dir():
        print(f"✗ Griechischer Poesie-Ordner '{search_root}' nicht gefunden – Abbruch."); sys.exit(1)
...
if __name__ == "__main__":
    main()
######## ENDE: gr_build_poesie_adapter.py ########
