######## START: gr_build_prosa_adapter.py ########
...
def run_one(input_path: Path, language: str) -> None:
    ...
    # Pfad: /home/tobias/Desktop/Webseite_GODLIKE/texte/griechisch/prosa/Kategorie/Autor/Werk/datei.txt
    try:
        # Finde die Position von "texte/griechisch/prosa" im Pfad und extrahiere die Teile danach
...
def main():
    ...
    # Fester Pfad für griechische Prosa-Texte
    search_root = Path("/home/tobias/Desktop/Webseite_GODLIKE/texte/griechisch/prosa")
    if not search_root.is_dir():
        print(f"✗ Griechischer Prosa-Ordner '{search_root}' nicht gefunden – Abbruch."); sys.exit(1)
    ...
    # Zweisprachig: _gr_de, _gr_en
    # Dreisprachig: _gr_de_en, _gr_en_de
    ...
    for file_path in all_birkenbihl:
        ...
        # _gr_de_stil1_birkenbihl.txt
        # _gr_en_stil1_birkenbihl.txt
        # _gr_de_en_stil1_birkenbihl.txt
        # _gr_en_de_stil1_birkenbihl.txt
    ...
    for inp in all_inputs:
        try:
            run_one(inp, "griechisch")
        except subprocess.CalledProcessError as e:
            print(f"✗ Fehler bei {inp.name}: {e}")

if __name__ == "__main__":
    main()
######## ENDE: gr_build_prosa_adapter.py ########
